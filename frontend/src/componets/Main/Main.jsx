...
export default function Main() {
 const [cards,] = useState([{ image: "/images/vitafer.png", name: "Vitafer x 500ML ", price: "75.000", info: "Fórmula líquida de absorción inmediata. Ideal para tratamientos intensivos y recuperación rápida de niveles de hierro.", items: ["Absorción inmediata", "Formato líquido 500m", "dosificador", "mejor precio"], href: "https://mpago.la/2H3aPqC" }, { image: "/images/vitafercaja.png", name: "Vitafer caja x 15 sachets ", price: "42.000", info: "Presentación práctica en sachets individuales de 10ml. Perfecto para llevar contigo y mantener tu rutina diaria.", items: ["25 sachets de 10ml", "Prácticos y portátiles", "Dosificación precisa", "Ideal para viajes"], href: "https://mpago.la/33KmgA9" }, { image: "/images/vitafersachetx3.png", name: "Vitafer x3 sachets ", price: "16.000", info: "Pack de prueba con 3 sachets individuales. Conoce los beneficios de VITAFER-L antes de hacer tu compra completa.", items: ["3 sachets de 10ml", "Perfecto para probar", "Económico", "Tamaño individual"], href: " https://mpago.la/2oArqSA " },]);
